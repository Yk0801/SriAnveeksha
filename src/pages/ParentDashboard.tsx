      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
        ...
        <div className="space-y-4">
          {announcements.map((a: any) => (
            <div key={a.id} className="p-4 border border-navy-100 rounded-xl bg-navy-50/30">
              <div className="flex gap-3">
                <Bell className="w-5 h-5 text-navy-500 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-bold text-slate-900 text-sm">{a.title}</h4>
                  <p className="text-[10px] font-bold text-navy-500 uppercase tracking-wide mb-2">{new Date(a.date).toLocaleDateString("en-GB")} · Audience: {a.audience}</p>
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
        ...
        <div className="bg-slate-50 rounded-xl p-6 border border-slate-200 mb-6 flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            ...
            <select className="w-full px-4 py-2.5 rounded-lg border border-slate-300 text-sm font-semibold bg-white focus:outline-none focus:border-[#d4af37]">
          ...
          <div className="flex items-end">
            <button className="w-full md:w-auto px-6 py-2.5 bg-[#d4af37] text-white font-bold text-sm rounded-lg hover:bg-[#c49e29] transition-colors whitespace-nowrap">
              Submit Request
            </button>
          </div>
        </div>
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center p-4 border border-slate-100 rounded-xl bg-white shadow-sm">
            ...
            <span className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-bold rounded-full bg-gold-100 text-gold-700">
        ...
        <div className="max-w-5xl mx-auto w-full">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Class {student.class}-{student.section} &nbsp;<span className="text-[#d4af37]">✨</span>&nbsp; Roll: {student.roll_no || student.admission_no}</p>
            </div>
          </div>
