    ...
    <section id="team" className="py-20 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
          <p className="text-[#F97316] font-semibold text-sm uppercase tracking-widest mb-3" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Our People</p>
        ...
        >
          ...
          <div className="w-full md:w-3/5 p-8 text-center md:text-left">
            ...
            <p className="text-[#F97316] text-sm font-bold uppercase tracking-wide mb-6" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>{principal.designation}</p>
          ...
          {teachers.map((t, i) => (
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-orange-50 flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-[#F97316] text-xs font-semibold" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>{t.subject}</p>
