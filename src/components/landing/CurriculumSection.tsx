...
const CurriculumSection = () => {
  ...
  return (
    <section id="curriculum" className="py-20 bg-gradient-to-br from-[#F97316]/5 via-white to-[#4F46E5]/5">
      <div className="max-w-6xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
          <p className="text-[#F97316] font-semibold text-sm uppercase tracking-widest mb-3" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Academics</p>
          ...
          >
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
              <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                <span className="w-2 h-5 bg-[#F97316] rounded-full" />
                Subjects Covered
              </h3>
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
                <h3 className="font-bold text-slate-800 mb-3 flex items-center gap-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  <span className="w-2 h-5 bg-[#4F46E5] rounded-full" />
                  Learning Approach
                </h3>
              ...
              <div className="bg-gradient-to-br from-[#4F46E5]/5 to-[#F97316]/5 rounded-2xl p-6 border border-[#4F46E5]/10">
                <h3 className="font-bold text-slate-800 mb-3 flex items-center gap-2" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                  <span className="w-2 h-5 bg-[#F97316] rounded-full" />
                  A Day in {activeTab}
                </h3>
